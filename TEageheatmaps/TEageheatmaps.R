###R script to create chromosome wise heatmaps for all the 10 sorghum lines
...
### calculate and save the mean TE age; borrowed from LC's script
...
### arranging all 10 heatmaps into one plot and saving the plot

myplot <- ggarrange(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,nrow=10,common.legend = TRUE, 
                    labels= c("Leoti","Rio","CA","pi229841","pi297155","pi300119","pi319311",
                              "pi506069","pi510757","pi655972"), legend ="bottom")
